...
1. Read `Signal inbox/CLAUDE.md § Domains` to find the available domains and their templates.
...
4. Write ONE markdown file to `Signal inbox/YYYY-MM-DD <slug>.md` where:
